...
TIME_KEY=["05_23","notime","notime"] #"put 05usualtime or notime"
time_window_min=0.5 # just changes saving names,nothing more
time_window_max=23 # 0.41
...
label_list_en = ["TB Data Electrons","TB MC New Electrons","TB MC old Electrons"]#["Pions(2W)","Pions(2Fe)","Pions(1Fe)"]
beam_en_list = [50,50,50]
