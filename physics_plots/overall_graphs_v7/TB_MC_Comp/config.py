...
IS_MC_TUNING=True ## If so, empty channels become -999 rather than 0. In this way, I calculate hit numbers correctly. because sipm can also produce 0 too.
...
name_data = f"50_gev_electron_comp"
...
beam_en_list = [180,180,180,180,180]
