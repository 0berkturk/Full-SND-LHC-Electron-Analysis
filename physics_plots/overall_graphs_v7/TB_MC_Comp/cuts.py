...
qdc_threshold_value_scifi_data = -500

#t_window_high_end_data = 2.2
#t_window_low_end_data = 0.5

time_window_max_us_ds_data=3
time_window_min_us_ds_data=3

qdc_threshold_value_scifi_mc = -500
BINARY_QDC_VALUES = False        # If True, sets all QDC > 0 to 1.0. applied after qdc threshold and timing. 
# ==========================================
...
# ------------------------------------------
cut_min_scifi_hitx_in_64r = 20
cut_min_scifi_hity_in_64r = 20
#scifi_hitx_in_128r
#scifi_hity_in_128r
#max_hor_hdw
#max_ver_hdw 
