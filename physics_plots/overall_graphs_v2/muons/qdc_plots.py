...
# Sum over channels, width, and height dimensions (dimensions 1, 2, 3)
    ...
    plt.title(f'Average QDC vs Muon Energy')
    plt.legend()
    plt.grid()
    ...
    plt.title('Total QDC vs Muon Energy')
    plt.grid()
    if os.path.exists("muon_en_qdc") is False:
        os.mkdir("muon_en_qdc")
...
TEST_DATA_DIR = ["/eos/user/b/beturk/snd/MonteCarlo/particle_gun_advanced_v1/merge_muon_gun_0_10/test_combined_muon_0_10_2025.pt"]
