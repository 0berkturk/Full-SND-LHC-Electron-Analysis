...
def load_as_lists(file_list,N):
    ...
    for fname in file_list:
        ...
        if PLOT_MEAN_HIT_NUMBERS:
            scifi_prop=data["scifi_05usualtime_hits_per_layer"]
            us_prop=data["us_3usualtime_hits_per_layer"]
            ds_hor_prop=data["dsh_notime_hits_per_layer"]
            ds_ver_prop=data["dsv_notime_hits_per_layer"]
        elif PLOT_MEAN_QDC_ENERGY:
            scifi_prop=data["scifi_05usualtime_qdc_per_layer"]
            us_prop=data["us_3usualtime_qdc_per_layer"]
            ds_hor_prop=data["dsh_notime_qdc_per_layer"]
            ds_ver_prop=data["dsv_notime_qdc_per_layer"]
...
def plot_for_QDC(TEST_DATA_DIR,name, IS_MC_DATA_TITLE):
    ...
    K=2
    xlabel="QDC Fraction of Highest 2 Layer"
    ...
    plot_multiple_hist(frac_highest_2layer, 40 , 0, 400, xlabel,
    ...
    plot_multiple_hist(frac_highest_2layer_ordered, 40 , 0, 400, xlabel,
