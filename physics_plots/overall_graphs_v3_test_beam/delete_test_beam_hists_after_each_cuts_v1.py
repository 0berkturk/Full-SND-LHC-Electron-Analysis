...
scifi_ds_2024_electrons_300GeV_run_100926 = True
...
IS_THERE_US_IN_DATA=False ## in 2024 tb, there is no us.
REJECT_US=False
i=0
...
if scifi_ds_2024_electrons_50GeV_run_100933:
    ...
    time_window_max=0.09 ## ideal value can be found when I change hit number by 2x 4x 0.5x the peak still stay same.
    time_window_min=0.09
    time_window_ds=3
    N=20
    ...
    min_pmt_qdc_value=0
    min_ds_pmt_qdc_value=0
    time_window_max=0.11 ## 0.32
    time_window_min=0.11 ## ideal value can be found when I change hit number by 2x 4x 0.5x the peak still stay same.
    time_window_ds=3
    N=20
    cluster_radius=64
    ...
    min_pmt_qdc_value=0
    min_ds_pmt_qdc_value=0
    time_window_max=0.5#0.25 ## 0.32
    time_window_min=0.5#0.25
    time_window_ds=3
    N=20
    HIT_NUMBER=500 ## İN THE HİST
    ...
    min_pmt_qdc_value=0
    min_ds_pmt_qdc_value=0
    time_window_max=0.35 ## 0.32
    time_window_min=0.35
    time_window_ds=3
    N=20
    HIT_NUMBER=500 ## İN THE HİST
...
N=10
for i in range(0,N):
    plot_2d_im(scifi,i,"images/scifi",int(energy[i]))
