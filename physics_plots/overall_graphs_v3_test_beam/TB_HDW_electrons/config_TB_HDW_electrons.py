...
if INCLUDE_NEG_QDC:
     ...
     outdirname="hdw_plots"+"_pos_and_neg_qdc"+str(time_window_min)+"_"+ str(time_window_max)
else:
    pos_and_neg_qdc_name=""
    outdirname="hdw_plots_beam_energy_"+str(time_window_min)+"_"+ str(time_window_max)
