...
def main():
    ...
    scifi_first_index_layer_second_index_energy_array = plot_for_QDC(TEST_DATA_DIR_DATA, name_data, "(TB Data)")

    #MC_scifi_first_index_layer_second_index_energy_array = plot_for_QDC(TEST_DATA_DIR_MC,name_MC,"(TB MC)")
