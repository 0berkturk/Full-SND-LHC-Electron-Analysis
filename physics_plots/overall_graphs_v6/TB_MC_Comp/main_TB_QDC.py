...
from test_beam_all_props_functions_v6 import *
...
def main():
    ...
    TEST_DATA_DIR_DATA.append("/eos/experiment/sndlhc/users/beturk/TB/TB_MC_New/Sparse_Datasets_2024/MCEB_TB_MC_2024_electron_50GeV__0.pt")
    ...
    if plot_prefix=="Mean_QDC_Energy":
        ...
        scifi_first_index_layer_second_index_energy_array = func_plot(TEST_DATA_DIR_DATA, name_data, f"", config_feature_name)
