...
cut_min_scifi_hitx_in_64r = 15
cut_min_scifi_hity_in_64r = 15

ONLY_POS_QDC = False
BINARY_QDC_VALUES = False        # If True, sets all QDC > 0 to 1.0
cut_max_scifi_05usualtime_total_qdc = 5000
cut_max_us_notime_total_qdc = 1000
cut_max_dsh_notime_total_qdc = 500
cut_max_dsv_notime_total_qdc = 750
# ==========================================
