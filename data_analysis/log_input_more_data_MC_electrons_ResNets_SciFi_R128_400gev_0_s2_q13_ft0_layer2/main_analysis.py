...
def all_in_one(file_names, dict_cuts, checkpoint_dir, base_save_name="energy_recon"):
    ...
    for file_path in file_names:
        ...
        save_dir = file_dir + "_DL_processed"
...
if __name__ == "__main__":
    model_checkpoint_path = "/eos/user/b/beturk/snd/dl_general/dl_energy_v9_onlyresnet_tunnedmc/log_input_more_data_MC_electrons_ResNets_SciFi_R128_400gev_0_s2_q13_ft0_layer2" # Update to actual path
    output_prefix = "energy_recon_log_input_more_data_MC_electrons_ResNets_SciFi_R128_400gev_0_s2_q13_ft0_layer2_"
    year="2022"
    ...
    my_cuts = {
        ...
        "t_window_data": [(0.5,2.3),(5,5)],
        "qdc_threshold_value_scifi_data": [0,1,2]
    }
    print("correct file")
    all_in_one(target_files, my_cuts, model_checkpoint_path+"/checkpoints", output_prefix)

    #update cuts
    # plot total_energy_dep per layer with those cuts. to compare with dl
    # plot total_hits per layer with those cuts to compare with dl
    # plot hdw per layer with those cuts to compare with dl
    #also save already calculated properties.....
