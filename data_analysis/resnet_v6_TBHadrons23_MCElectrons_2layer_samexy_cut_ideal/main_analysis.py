...
if __name__ == "__main__":
    model_checkpoint_path = "/eos/user/b/beturk/snd/dl_general/dl_cls_v9/resnet_v6_TBHadrons23_MCElectrons_2layer_samexy_cut_ideal" # Update to actual path
    output_prefix = "CLS_resnet_v6_TBHadrons23_MCElectrons_2layer_samexy_cut_ideal_"
    year="2022"
