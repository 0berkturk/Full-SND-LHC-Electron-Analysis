...
for i in range(len(x)):
    ...
    files = glob.glob(f"/eos/experiment/sndlhc/users/beturk/TB/TB_MC_New/2024/{energy}GeV_11_W/X_neg{x[i]:.2f}_Y_{y[i]:.2f}_Z_315/*/sndLHC.PG_11-TGeant4_MCEB_digCPP.root",recursive=True)
